...
in
{
  ...
  config = lib.mkIf cfg.enable {
    ...
    services.kanidm.clientSettings.uri = "https://testing-idm.${config.homelab.tld}";
    services.kanidm.unixSettings.pam_allowed_login_groups = [ "idm_all_persons@testing-idm.fogbox.uk" ];
    services.openssh.authorizedKeysCommand = "${lib.getExe' pkgs.kanidm "kanidm_ssh_authorizedkeys"} %u";
